        ...
        <div className="container p-4">
            <div className="mb-4">
                ...
                <p className="fst-italic">
                    PANUTO: Lagyan ng tsek (✓) ang tumutugon sa iyong sagot sa Citizen's Charter (CC). Ang Citizen's Charter (CC) ay opisyal na
                    dokumento na nagsasaad ng mga serbisyo sa isang ahensya ng gobyerno, kasama ang mga kakailanganin na dokumento, bayarin,
                    at panahong gagugalin sa pagpoproseso.
                </p>
            </div>
            ...
            <div className="row mb-4">
                <div className="col-12">
                    <h5>CC1: Which of the following best describes your awareness of a CC?</h5>
                    <p className="fst-italic">(Alin sa mga sumusunod ang naglarawan sa iyong kaalaman sa CC?)</p>
                    ...
                    <div className="form-check mb-2">
                        ...
                        <label className="form-check-label" htmlFor="cc1_1">
                            ...
                            <br />
                            <span className="fst-italic">(Alam ko ang CC at nakita ko ito sa napuntahang tanggapan.)</span>
                        </label>
                    </div>
                    ...
                    <div className="form-check mb-2">
                        ...
                        <label className="form-check-label" htmlFor="cc1_2">
                            ...
                            <br />
                            <span className="fst-italic">(Alam ko ang CC pero hindi ko ito nakita sa napuntahang tanggapan.)</span>
                        </label>
                    </div>
                    ...
                    <div className="form-check mb-2">
                        ...
                        <label className="form-check-label" htmlFor="cc1_3">
                            ...
                            <br />
                            <span className="fst-italic">(Nalaman ko ang CC noon lamang nakita ko ito sa napuntahang tanggapan.)</span>
                        </label>
                    </div>
                    ...
                    <div className="form-check mb-2">
                        ...
                        <label className="form-check-label" htmlFor="cc1_4">
                            ...
                            <br />
                            <span className="fst-italic">(Hindi ko alam kung ano ang CC at wala akong nakita sa napuntahang tanggapan (Lagyan ng tsek at 'N/A' sa CC2 at CC3))</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div className="row mb-4">
                <div className="col-12">
                    <h5>CC2: If aware of CC (answered 1-3 in CC1), would you say that the CC of this office was...?</h5>
                    <p className="fst-italic">(Kung alam ang CC (kung sinagutan ang 1-3 sa CC1), masasabi mo ba na ang CC ng napuntahang tanggapan ay...?)</p>
            ...
            <div className="row mb-4">
                <div className="col-12">
                    <h5>CC3: If aware of CC (answered codes 1-3 in CC1), how much did the CC help you in your transaction?</h5>
                    <p className="fst-italic">(Kung alam ang CC (kung sinagutan ang 1-3 sa CC1), gaano nakatulong ang CC sa transaksyon mo?)</p>
